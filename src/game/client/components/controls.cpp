...
int CControls::SnapInput(int *pData)
{
	...
	{
		switch(g_Config.m_ClAutoFire)
		{
			case 1:
				m_InputData[g_Config.m_ClDummy].m_Fire = -m_InputData[g_Config.m_ClDummy].m_Fire+1;
				break;
			case 2:
				m_InputData[g_Config.m_ClDummy].m_Hook = -m_InputData[g_Config.m_ClDummy].m_Hook+1;
				break;
		}
		
		if (not g_Config.m_ClWeirdControls)
		{
		...
		else if (g_Config.m_ClWeirdControls == 1)
		{
			if (m_InputData[g_Config.m_ClDummy].m_Hook or m_InputData[g_Config.m_ClDummy].m_Fire == 1)
			{
				m_InputData[g_Config.m_ClDummy].m_TargetX = (int)m_MousePos[g_Config.m_ClDummy].x;
				m_InputData[g_Config.m_ClDummy].m_TargetY = (int)m_MousePos[g_Config.m_ClDummy].y;
				if(!m_InputData[g_Config.m_ClDummy].m_TargetX && !m_InputData[g_Config.m_ClDummy].m_TargetY)
			...
			else if (m_InputData[g_Config.m_ClDummy].m_Fire > 1) m_InputData[g_Config.m_ClDummy].m_Fire = 0;
		}
		
		else if (g_Config.m_ClWeirdControls == 2)
		{
			if (not m_InputData[g_Config.m_ClDummy].m_Hook and not m_InputData[g_Config.m_ClDummy].m_Fire)
			{
				m_InputData[g_Config.m_ClDummy].m_TargetX = -(int)m_MousePos[g_Config.m_ClDummy].x;
				m_InputData[g_Config.m_ClDummy].m_TargetY = -(int)m_MousePos[g_Config.m_ClDummy].y;
				if(!m_InputData[g_Config.m_ClDummy].m_TargetX && !m_InputData[g_Config.m_ClDummy].m_TargetY)
			...
			else if (m_InputData[g_Config.m_ClDummy].m_Hook or m_InputData[g_Config.m_ClDummy].m_Fire == 1)
			{
				m_InputData[g_Config.m_ClDummy].m_TargetX = (int)m_MousePos[g_Config.m_ClDummy].x;
				m_InputData[g_Config.m_ClDummy].m_TargetY = (int)m_MousePos[g_Config.m_ClDummy].y;
				if(!m_InputData[g_Config.m_ClDummy].m_TargetX && !m_InputData[g_Config.m_ClDummy].m_TargetY)
			...
			if (m_InputData[g_Config.m_ClDummy].m_Fire > 1) m_InputData[g_Config.m_ClDummy].m_Fire = 0;
		}
